...
function customBackgroundColor() {
    $('*[data-background-color="custom"]').each(function () {
        $(this).is("[custom-color]") ? $(this).css("background", $(this).attr("custom-color")) : $(this).is("[custom-background]") && $(this).css("background-image", "url(" + $(this).attr("custom-background") + ")");
    });
}

function legendClickCallback(s) {
    for (var a = (s = s || window.event).target || s.srcElement;
    ...
    i.legend.options.onClick.call(i, s, i.legend.legendItems[n]), i.isDatasetVisible(n) ? a.classList.remove("hidden") : a.classList.add("hidden");
}
...
$(".nav-search .input-group > input")
    ...
    $(function () {
        $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), layoutsColors(), customBackgroundColor();
    }),
    $(document).ready(function () {
        ...
        if (!c) {
            (C = $(".sidenav-toggler")).on("click", function () {
                    1 == u ? ($("html").removeClass("nav_open"), C.removeClass("toggled"), (u = 0)) : ($("html").addClass("nav_open"), C.addClass("toggled"), (u = 1));
                }),
                (c = !0);
        }
        if (!h) {
        ...
        if (!d) {
            ...
            k.on("click", function () {
                    1 == m ? ($("html").removeClass("topbar_open"), k.removeClass("toggled"), (m = 0)) : ($("html").addClass("topbar_open"), k.addClass("toggled"), (m = 1));
                }),
                (d = !0);
        }
        if (!g) {
            var w = $(".toggle-sidebar");
            $(".wrapper").hasClass("sidebar_minimize") && ((v = 1), w.addClass("toggled"), w.html('<i class="icon-options-vertical"></i>')),
                w.on("click", function () {
                    1 == v ?
                        ($(".wrapper").removeClass("sidebar_minimize"), w.removeClass("toggled"), w.html('<i class="icon-menu"></i>'), (v = 0)) :
                        ($(".wrapper").addClass("sidebar_minimize"), w.addClass("toggled"), w.html('<i class="icon-options-vertical"></i>'), (v = 1)),
                        $(window).resize();
                }),
                (g = !0);
        }
        ...
        $(".wrapper").hasClass("is-show") && ((b = 1), y.addClass("toggled"), y.html('<i class="icon-options-vertical"></i>')),
            y.on("click", function () {
                1 == b ?
                    ($(".wrapper").removeClass("is-show"), y.removeClass("toggled"), y.html('<i class="icon-menu"></i>'), (b = 0)) :
                    ($(".wrapper").addClass("is-show"), y.addClass("toggled"), y.html('<i class="icon-options-vertical"></i>'), (b = 1)),
                    $(window).resize();
            }),
            (g = !0),
            $(".sidebar").hover(
