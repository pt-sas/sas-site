<!-- footer -->
<p>© Copyright <?= date('Y') ?> PT Sahabat Abadi Sejahtera - All rights reserved.</p>
...
<a href="javascript:void(0);" onclick="window.open('https://www.instagram.com/sahabatabadi_official', '_blank')" class="foot-socmed"><i class="fa fa-instagram"></i></a>