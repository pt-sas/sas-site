          ...
          <li>
            <div class="message-notif-scroll scrollbar-outer">
              <div class="notif-center">
                <a href="#">
                  <div class="notif-img">
                    <img src="<?= base_url('custom/image/undraw_profile_1.svg') ?>" alt="Img Profile">
                  </div>
                ...
                <a href="#">
                  <div class="notif-img">
                    <img src="<?= base_url('custom/image/undraw_profile_2.svg') ?>" alt="Img Profile">
                  </div>
                  <div class="notif-content">
                ...
                <a href="#">
                  <div class="notif-img">
                    <img src="<?= base_url('custom/image/undraw_profile_3.svg') ?>" alt="Img Profile">
                  </div>
                  <div class="notif-content">
