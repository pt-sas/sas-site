  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
      ...
      <ul class="nav nav-primary">
            ...
            <ul class="nav nav-collapse">
              <li>
                <a href="<? //= base_url('/backend/about') 
                          ?>"><span class="sub-item">About Us</span></a>
              </li>
              <li>
                <a href="<? //= base_url('/backend/location') 
                          ?>"><span class="sub-item">Our Location</span></a>
              </li>
            </ul>
          </div>
        </li> -->
        <li class="nav-item">
          ...
          <div class="collapse" id="collapseProduct">
            <ul class="nav nav-collapse">
              <!-- <li>
                <a href="<? //= base_url('/backend/principal') 
                          ?>"><span class="sub-item">Principal</span></a>
              </li>
              <li>
                <a href="<? //= base_url('/backend/productgroup') 
                          ?>"><span class="sub-item">Product Group</span></a>
              </li> -->
              <li>
        ...
        <ul class="nav nav-collapse">
          <li>
            <a href="<? //= base_url('/backend/news') 
                      ?>"><span class="sub-item">News</span></a>
          </li>
          <li>
            <a href="<? //= base_url('/backend/event') 
                      ?>"><span class="sub-item">Event</span></a>
          </li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="collapseCareer">
        <ul class="nav nav-collapse">
          <li>
            <a href="<? //= base_url('/backend/division') 
                      ?>"><span class="sub-item">Division</span></a>
          </li>
          <li>
            <a href="<? //= base_url('/backend/job') 
                      ?>"><span class="sub-item">Job</span></a>
          </li>
        </ul>
      </div>
    </li>
