            ...
            <div class="quick-scroll scrollbar-outer">
              <div class="quick-content contact-content">
                ...
                <div class="avatar-group">
                  <div class="avatar">
                    <img src="<?= base_url('custom/image/undraw_profile_1.svg') ?>" alt="..." class="avatar-img rounded-circle border border-white">
                  </div>
                  <div class="avatar">
                  ...
                  <div class="user">
                    <a href="#">
                      <div class="avatar avatar-offline">
                        <img src="<?= base_url('custom/image/undraw_profile_2.svg') ?>" alt="..." class="avatar-img rounded-circle border border-white">
                      </div>
                      <div class="user-data2">
                  ...
                  <div class="user">
                    <a href="#">
                      <div class="avatar avatar-away">
                        <img src="<?= base_url('custom/image/undraw_profile_3.svg') ?>" alt="..." class="avatar-img rounded-circle border border-white">
                      </div>
                      <div class="user-data2">
